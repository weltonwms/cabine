...
/**
 * passagemcomando Component Unidade Controller
 *
 * @category Controller
 * @package  passagemcomando
 * @author   Caroline <carolinesantossin@gmail.com>
 ...
 * @since    1.0
 */
class unidadesControllerUnidade extends unidadesController
{
    /**
     * Constructor
     *
    ...
    public function save()
    {
        ...
        $model = $this->getModel('Unidade');
        if ($model->save()) {
            $msg = JText::_('Object created successfully!');
            $url = 'index.php?option=com_unidades&view=Unidade&layout=list';
        } else {
            $msg = JText::_('Error while created object: '.$model->getError());
            $url = 'index.php?option=com_unidades&view=Unidade&layout=new';
        }
