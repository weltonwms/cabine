...
/**
 * Concursos Component Concurso Controller
 *
 * @category Controller
 * @package  Concursos
 * @author   Welton Moreira dos Santos <weltonwms@gmail.com>
 ...
 * @since    1.0
 */
class ConcursosControllerConcurso extends ConcursosController
{
    /**
     * Constructor
     *
    ...
    public function save()
    {
        ...
        if ($model->save()) {
            ...
            $url = 'index.php?option=com_concursos&view=Concurso&layout=list';
        } else {
            $msg = JText::_('Error while created object: '.$model->getError());
            $url = 'index.php?option=com_concursos&view=Concurso&layout=new';
        }
