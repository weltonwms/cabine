...
class ConcursosViewConcursos extends JViewLegacy {
    ...
    function display($tpl = null) {
        ...
        // Set the submenu
        ConcursosHelper::addSubmenu('concursos');
    ...
    protected function addToolBar() {
        $title = JText::_('MANAGE CONCURSOS');
        JToolBarHelper::title($title);
        JToolBarHelper::addNew('concurso.add', 'JTOOLBAR_NEW');
        JToolBarHelper::editList('concurso.edit', 'JTOOLBAR_EDIT');
        JToolBarHelper::deleteList('Deseja Realmente Apagar?', 'concursos.delete', 'JTOOLBAR_DELETE');
